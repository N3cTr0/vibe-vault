...
<Window x:Class="PartnerTool.PerformanceWindow"
        ...
        Title="Performance" Width="900" Height="600" MinWidth="720" MinHeight="480"
    ...
    <Window.Resources>
        <!-- Each rail tile is a visible boxed card; the selected one gets a bright border (set in
             code), and hovering lightens the fill. Background is left to the style so the hover
             trigger works (code marks selection via the border, not the background). -->
        <Style x:Key="RailTile" TargetType="Border">
            ...
            <Style.Triggers>
                <Trigger Property="IsMouseOver" Value="True">
                    <Setter Property="Background" Value="#242536"/>
                </Trigger>
            </Style.Triggers>
        </Style>
    </Window.Resources>
    ...
    <Grid>
        ...
        <ScrollViewer Grid.Column="0" Background="#181825" VerticalScrollBarVisibility="Auto">
            <StackPanel Margin="10,12">
                <Border x:Name="TileCpu" Tag="cpu" Style="{StaticResource RailTile}" MouseLeftButtonUp="Tile_Click">
                    <DockPanel>
                ...
                <Border x:Name="TileMem" Tag="mem" Style="{StaticResource RailTile}" MouseLeftButtonUp="Tile_Click">
                    <DockPanel>
                        <Border DockPanel.Dock="Left" Width="58" Height="36" Background="#11111B" CornerRadius="4" ClipToBounds="True" Margin="0,0,10,0">
                ...
                <Border x:Name="TileDisk" Tag="disk" Style="{StaticResource RailTile}" MouseLeftButtonUp="Tile_Click">
                    <DockPanel>
                        <Border DockPanel.Dock="Left" Width="58" Height="36" Background="#11111B" CornerRadius="4" ClipToBounds="True" Margin="0,0,10,0">
                ...
                <Border x:Name="TileNet" Tag="net" Style="{StaticResource RailTile}" MouseLeftButtonUp="Tile_Click">
                    <DockPanel>
                        <Border DockPanel.Dock="Left" Width="58" Height="36" Background="#11111B" CornerRadius="4" ClipToBounds="True" Margin="0,0,10,0">
        ...
        <Grid Grid.Column="1" Margin="22,18,22,18">
            ...
            <Border Grid.Row="1" Background="#11111B" CornerRadius="6" ClipToBounds="True" Margin="0,12">
                <Grid>
