...
- **Disaster recovery:** no remote yet — the vault snapshot in `Code\` is the fallback, regenerated by `tools\sync-vault.ps1`. Run it manually until a git hook exists.
